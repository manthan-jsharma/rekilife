/** Inline wooden line-art hand — pure SVG + CSS, visible on first HTML paint. */
export default function WoodenHandLines({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        className="wooden-hand-line"
        pathLength={1}
        d="M118 468 C92 430 78 390 88 348 C98 308 118 278 142 252 C168 224 198 210 228 198"
        stroke="url(#reki-wood-stroke-a)"
        strokeWidth="2.8"
        strokeLinecap="round"
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-1"
        pathLength={1}
        d="M228 198 C268 188 302 176 328 158 C352 142 372 118 380 92"
        stroke="url(#reki-wood-stroke-b)"
        strokeWidth="2.6"
        strokeLinecap="round"
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-2"
        pathLength={1}
        d="M142 252 C128 228 118 200 124 172 C130 152 148 138 168 132 C188 126 208 134 218 152"
        stroke="url(#reki-wood-stroke-c)"
        strokeWidth="2.4"
        strokeLinecap="round"
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-3"
        pathLength={1}
      ...
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-4"
        pathLength={1}
      ...
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-5"
        pathLength={1}
      ...
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-6"
        pathLength={1}
      ...
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-7"
        pathLength={1}
      ...
      />
      <path
        className="wooden-hand-line wooden-hand-line-delay-8"
        pathLength={1}
